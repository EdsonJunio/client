...
Route::get('grant-password', function () {
    ...
    $response = Http::post(env('API_URL') . 'oauth/token', [
        'grant_type' => 'password',
        'client_id' => 3,
        'client_secret' => 'rvBiYbEExc1WxrKm05ZyMNPAZAsWmnbIfTScrRN6',
        'username' => 'edsonbh97@gmail.com',
        'password' => 'Eds@123*',
        'scope' => '',
    ]);
    dd($response->json());
...
Route::get('grant-client', function () {
    ...
    $response = Http::post(env('API_URL') . 'oauth/token', [
        ...
        'client_id' => 4,
        'client_secret' => 'gLgcYIRsr7LsUuxaQ8Z20YpFCbr35rx7w0TgKwgS',
        'scope' => '',
